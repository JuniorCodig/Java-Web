<%@page import="br.grupointegrado.ads.gerenciadorDeProdutos.Util.Formatter"%>
<%@page import="br.grupointegrado.ads.gerenciadorDeProdutos.modelos.Produto"%>
<%@page import="java.util.List"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>

<%
    //Se produto diferente de null, ele retorna para a pagina os valores...
    Produto produto;
    ...
    <head>
        ...
        <script>
            function validaCadastro(event){
                ...
                var qtdaInput = document['form-produto']['produto-quantidade'];
                ...
                if (!validaNumber (qtdaInput.value, 0, Number.MAX_VALUE)) {
                    formValido = false;
                    qtdaInput.classList.add('is-invalid');
                    qtdaInput.classList.remove('is-valid');
                }else{
                    qtdaInput.classList.remove('is-invalid');
                    qtdaInput.classList.add('is-valid');
                }
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <a href="?produto=<%= p.getId()%>" class="btn">
                                    Editar
                                </a>
